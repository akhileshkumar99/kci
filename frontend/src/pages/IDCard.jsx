        ...
        {idCardTemplate ? (
          ...
          >
            <div style={{ background: '#fff', borderBottom: '2px solid #d4af37', display: 'flex', alignItems: 'center', padding: '4px 8px', gap: 6, flexShrink: 0 }}>
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: '#0b1f5b', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <span style={{ color: '#fff', fontSize: 8, fontWeight: 900 }}>KCI</span>
              </div>
