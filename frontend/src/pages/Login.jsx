...
export default function Login() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#EBEFF8] text-[#0F172A] font-sans relative overflow-x-hidden pt-2 sm:pt-4 lg:pt-16 pb-8">
      <div className="w-full min-h-screen bg-[#EBEFF8] text-[#0F172A] font-sans relative overflow-x-hidden pt-10 sm:pt-14 lg:pt-18 pb-8">
        {/* BACKGROUND GRAPHIC CURVE */}
        <div
          className="absolute top-0 left-0 w-full lg:w-[62%] h-[280px] sm:h-[350px] lg:h-full bg-gradient-to-br from-[#0B1536] via-[#0E2055] to-[#1E3A8A] z-0"
    ...
    <div className="w-full min-h-screen bg-[#EBEFF8] text-[#0F172A] font-sans relative overflow-x-hidden pt-12 sm:pt-16 lg:pt-20 pb-8">
      ...
      <div className="relative z-20 max-w-[1440px] mx-auto px-4 sm:px-6 py-2 sm:py-3 flex justify-between lg:justify-end items-center gap-4 text-xs font-semibold">
        ...
        {/* TOP HEADER CONTROLS (Top Right of Page) */}
        <div className="relative z-20 max-w-[1440px] mx-auto px-4 sm:px-6 py-2 sm:py-4 flex justify-between lg:justify-end items-center gap-4 text-xs font-semibold">
          <div className="relative z-20 max-w-[1440px] mx-auto px-4 sm:px-6 py-2 sm:py-3 flex justify-between lg:justify-end items-center gap-4 text-xs font-semibold">
            <div className="lg:hidden flex items-center gap-2 text-white">
              <img src="/logo.png" alt="Logo" className="w-8 h-8 rounded-full border border-white/30" />
              <span className="font-bold tracking-tight text-sm">KEERTI COMPUTER INSTITUTE</span>
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          {/* MAIN CONTAINER */}
          <div className="relative z-10 max-w-[1440px] mx-auto px-3 sm:px-8 lg:px-12 py-2 lg:py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[calc(100vh-80px)]">
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 py-3 lg:py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[calc(100vh-120px)] mt-2 sm:mt-4">
      {/* MAIN CONTAINER */}
                    ...
                    {roles.map(({ id, label, icon: Icon }) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => setActiveRole(id)}
                          className={`flex items-center justify-center gap-1 sm:gap-1.5 py-2 sm:py-2.5 px-1.5 rounded-xl text-[11px] sm:text-xs font-bold transition-all ${isSelected
                              ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md shadow-blue-500/20'
                              : 'text-slate-600 hover:text-slate-900 hover:bg-white/60'
                            }`}
                        >
